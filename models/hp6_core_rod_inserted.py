...
- Central B4C control rod fully inserted (modeled as a solid absorber cylinder)
...
CASE_NAME = "hp6_rod_inserted_B4C_Na_T600_refl10"
...
xy_raw = "results/plots/geometry_xy_raw_inserted.png"
xz_raw = "results/plots/geometry_xz_raw_inserted.png"
...
save_annotated_plot(
    raw_png_path=xy_raw,
    out_png_path="results/plots/geometry_xy_inserted.png",
    title="Microreactor Geometry (XY Midplane, Rod Inserted)",
    xlabel="x (cm)",
    ylabel="y (cm)",
    x_span_cm=xy_span,
    y_span_cm=xy_span,
...
save_annotated_plot(
    raw_png_path=xz_raw,
    out_png_path="results/plots/geometry_xz_inserted.png",
    title="Microreactor Geometry (XZ Axial Slice, Rod Inserted)",
    xlabel="x (cm)",
    ylabel="z (cm)",
    x_span_cm=xz_span_x,
